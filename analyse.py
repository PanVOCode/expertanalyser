...
def analyse(channel_url):
    ...
    # Создаем папку для результатов в all_folders
    out_dir = Path('all_folders') / channel_username
    ...
    with TelegramClient('session_name', api_id, api_hash) as client:
        ...
        if CREATE_MULTIPLE_SORTED_FILES:
            ...
            def save_to_excel_dir(df, filename, channel_username, start_date, end_date):
                save_to_excel(df, out_dir / filename, channel_username, start_date, end_date)
